...
EXAM_SHEET_SCAN_SERVICE_NAME="${EXAM_SHEET_SCAN_SERVICE_NAME:-workspace-examination-sheet-scan.service}"
EXAM_SHEET_SCAN_TIMER_NAME="${EXAM_SHEET_SCAN_TIMER_NAME:-workspace-examination-sheet-scan.timer}"
